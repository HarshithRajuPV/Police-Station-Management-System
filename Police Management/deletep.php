...
<body>
<div class="headtop">
<h3 >Police Database Deletion</h3>
...
<ul class="uplis">
  ...
  <li class="lis"><a href="police.php" class="a">Police Database</a></li>
    ...
    <form action="delete.php" method="post">
        <span>Police ID:</span> <br>
        <input type="text" name="pid"> <br>
        <center>
        <button name="enter" class="btn" onclick='alert("Deleted Successfully")'>Delete</button>
        </center>
    </form>
</div>
</body>
